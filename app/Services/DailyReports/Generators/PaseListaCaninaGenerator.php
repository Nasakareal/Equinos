...
class PaseListaCaninaGenerator implements DailyReportGenerator
{
    public function tipo(): string
    {
        return 'pase_lista_canina';
    }

    public function label(): string
    {
        return 'Pase de Lista Canina';
    }
    ...
    public function generar(string $fecha, int $turno_id, array $params = []): string
    {
        ...
        */
        ...
        $fileName = $fechaArchivo . ' PASE DE LISTA CANINA.xlsx';

{{-- resources/views/armamento/create.blade.php --}}

@extends('adminlte::page')

@section('title', 'Crear Armamento')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('armamento.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="tipo" id="tipo" class="form-control @error('tipo') is-invalid @enderror" required>
                                        ...
                                        <option value="CORTA" {{ old('tipo') === 'CORTA' ? 'selected' : '' }}>CORTA</option>
                                        <option value="LARGA" {{ old('tipo') === 'LARGA' ? 'selected' : '' }}>LARGA</option>
                                    </select>
                                    @error('tipo')

...
@section('title', 'Pase Lista Agrupamiento Equinos y Caninos')

@section('content_header')
    <h1>Pase Lista Agrupamiento Equinos y Caninos</h1>
@stop
            ...
            <tbody>
                @forelse($reportes as $r)
                    <tr>
                        ...
                        <td>{{ $r->archivo ?? '—' }}</td>
                        <td>
                            <a href="{{ route('daily_reports.descargar', [$r->id, 'pase_lista_agrupamiento_equinos_caninos']) }}" class="btn btn-success btn-sm">

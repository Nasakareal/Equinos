...
<?php $__env->startSection('title', 'Editar Equinoterapia'); ?>
...
<form action="<?php echo e(route('equinoterapias.update', $equinoterapia->id)); ?>" method="POST">
    <?php echo csrf_field(); ?>
            ...
            <div class="card card-outline card-pink">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(route('equinoterapias.show', $equinoterapia->id)); ?>" class="btn btn-info btn-sm">
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('fecha', \Carbon\Carbon::parse($equinoterapia->fecha)->format('Y-m-d'))); ?>"
                                       required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       class="form-control"
                                       min="0"
                                       value="<?php echo e(old('personal', $equinoterapia->personal)); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       class="form-control"
                                       min="0"
                                       value="<?php echo e(old('equinos', $equinoterapia->equinos)); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       class="form-control"
                                       min="0"
                                       value="<?php echo e(old('valoraciones', $equinoterapia->valoraciones)); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="actividades_area"
                                          class="form-control"
                                          rows="3"><?php echo e(old('actividades_area', $equinoterapia->actividades_area)); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="observaciones"
                                          class="form-control"
                                          rows="3"><?php echo e(old('observaciones', $equinoterapia->observaciones)); ?></textarea>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-sm">
                            ...
                            <tbody id="contenedor-registros">
                                ...
                                <?php $__currentLoopData = $equinoterapia->registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="fila-registro">
                                    ...
                                    <td>
                                        <input type="text"
                                               ...
                                               class="form-control"
                                               value="<?php echo e($registro->nombre_completo); ?>">
                                    </td>

                                    <td>
                                        <select name="sexo[]" class="form-control select-sexo">
                                            <option value="NIÑO" <?php echo e($registro->sexo == 'NIÑO' ? 'selected' : ''); ?>>NIÑO</option>
                                            <option value="NIÑA" <?php echo e($registro->sexo == 'NIÑA' ? 'selected' : ''); ?>>NIÑA</option>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <input type="text"
                                               name="diagnostico[]"
                                               class="form-control"
                                               value="<?php echo e($registro->diagnostico); ?>">
                                    </td>

                                    <td>
                                        <select name="estatus_asistencia[]" class="form-control select-asistencia">
                                            <option value="ASISTIO" <?php echo e($registro->estatus_asistencia == 'ASISTIO' ? 'selected' : ''); ?>>ASISTIÓ</option>
                                            <option value="INASISTIO" <?php echo e($registro->estatus_asistencia == 'INASISTIO' ? 'selected' : ''); ?>>INASISTIÓ</option>
                                        </select>
                                    </td>

                                    <td>
                                        <select name="es_valoracion[]" class="form-control select-valoracion">
                                            <option value="0" <?php echo e(!$registro->es_valoracion ? 'selected' : ''); ?>>NO</option>
                                            <option value="1" <?php echo e($registro->es_valoracion ? 'selected' : ''); ?>>SÍ</option>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <input type="text"
                                               ...
                                               value="<?php echo e($registro->motivo_inasistencia); ?>"
                                               <?php echo e($registro->estatus_asistencia == 'ASISTIO' ? 'disabled' : ''); ?>>
                                    </td>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\equinosCaninos\resources\views/equinoterapias/edit.blade.php ENDPATH**/ ?>
...
<head>
  ...
  <title><?php echo e(config('app.name', 'Equinos y Caninos')); ?></title>
        ...
        <div class="d-flex align-items-center gap-2">
          <?php if(Route::has('login')): ?>
            <?php if(auth()->guard()->check()): ?>
              <a href="<?php echo e(url('/home')); ?>" class="btn btn-sm btn-glow px-3">
                <i class="fa-solid fa-gauge-high me-2"></i> Ir al panel
              </a>
            <?php else: ?>
              <a href="<?php echo e(route('login')); ?>" class="btn btn-sm btn-outline-soft px-3">
  ...
  <div id="contacto" class="container my-5">
    <div class="glass p-4 p-md-5">
      ...
      <div class="footer d-flex flex-column flex-md-row justify-content-between gap-2">
        <div>
          © <?php echo e(date('Y')); ?> • Agrupamiento de Equinos y Caninos • SSP Michoacán
        </div>
        <div class="tiny-note">
...
<?php /**PATH C:\wamp64\www\equinosCaninos\resources\views/welcome.blade.php ENDPATH**/ ?>
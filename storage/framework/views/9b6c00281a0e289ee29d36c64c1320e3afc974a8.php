            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(url('/admin/settings/responsables/create')); ?>" class="btn btn-primary">
                ...
                <div class="card-body">
                    <table id="responsables" class="table table-striped table-bordered table-hover table-sm">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $responsables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td style="text-align: center"><?php echo e($index + 1); ?></td>
                                    <td><?php echo e($r->personal->nombres ?? 'SIN PERSONAL'); ?></td>
                                    <td><?php echo e($r->nivel); ?></td>
                                    <td>
                                        <?php if($r->nivel === 'GENERAL'): ?>
                                            GENERAL
                                        <?php else: ?>
                                            <?php echo e($r->area->nombre ?? 'SIN ÁREA'); ?>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(url('/admin/settings/responsables/' . $r->id . '/edit')); ?>" class="btn btn-success btn-sm">
                                                <i class="fa-regular fa-pen-to-square"></i>
                                            </a>

                                            <form action="<?php echo e(url('/admin/settings/responsables/' . $r->id)); ?>"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\equinosCaninos\resources\views/admin/settings/responsables/index.blade.php ENDPATH**/ ?>
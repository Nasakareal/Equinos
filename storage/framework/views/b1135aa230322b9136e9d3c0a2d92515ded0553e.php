            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(url('/admin/settings/areas/create')); ?>" class="btn btn-primary">
                            <i class="fa-solid fa-plus"></i> Crear Nueva Área
                        </a>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(optional($area->created_at)->format('d-m-Y')); ?></td>
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(url('/admin/settings/areas/' . $area->id . '/edit')); ?>" class="btn btn-success btn-sm">
                                                <i class="fa-regular fa-pen-to-square"></i>
                                            </a>

                                            <form action="<?php echo e(url('/admin/settings/areas/' . $area->id)); ?>"
...
<?php $__env->startSection('js'); ?>
    <script>
        $(function () {
            ...
            }).buttons().container().appendTo('#areas_wrapper .col-md-6:eq(0)');
        });
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\equinosCaninos\resources\views/admin/settings/areas/index.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="sv-card">
                    ...
                    <div class="sv-card__body">
                        ...
                        <a href="<?php echo e(url('/admin/settings/personal')); ?>" class="btn sv-btn">
                            <i class="fas fa-arrow-right"></i> Acceder
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="sv-card">
                    ...
                    <div class="sv-card__body">
                        ...
                        <a href="<?php echo e(url('/admin/settings/armamento')); ?>" class="btn sv-btn">
                            <i class="fas fa-arrow-right"></i> Acceder
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="sv-card">
                    ...
                    <div class="sv-card__body">
                        ...
                        <a href="<?php echo e(url('/admin/settings/armamento-asignaciones')); ?>" class="btn sv-btn">
                            <i class="fas fa-arrow-right"></i> Acceder
                        </a>
                    </div>
                </div>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ver patrullas')): ?>
            <div class="col-md-3 col-sm-6 col-12">
                <div class="sv-card">
                    ...
                    <div class="sv-card__body">
                        ...
                        <a href="<?php echo e(url('/admin/settings/patrullas')); ?>" class="btn sv-btn">
                            <i class="fas fa-arrow-right"></i> Acceder
                        </a>
                    </div>
                </div>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ver patrullas asignaciones')): ?>
            <div class="col-md-3 col-sm-6 col-12">
                <div class="sv-card">
                    <div class="sv-card__icon bg-info">
                    ...
                    <div class="sv-card__body">
                        ...
                        <a href="<?php echo e(url('/admin/settings/patrullas-asignaciones')); ?>" class="btn sv-btn">
                            <i class="fas fa-arrow-right"></i> Acceder
                        </a>
                    </div>
                </div>

...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="Veterinario" <?php echo e(old('actividad', $personal->actividad) == 'Veterinario' ? 'selected' : ''); ?>>Veterinario</option>
                                        <option value="Cuartelero" <?php echo e(old('actividad', $personal->actividad) == 'Cuartelero' ? 'selected' : ''); ?>>Cuartelero</option>
                                        <option value="Arrendador" <?php echo e(old('actividad', $personal->actividad) == 'Arrendador' ? 'selected' : ''); ?>>Arrendador</option>
                                        <option value="Administrativo" <?php echo e(old('actividad', $personal->actividad) == 'Administrativo' ? 'selected' : ''); ?>>Administrativo</option>
                                        <option value="Operativo" <?php echo e(old('actividad', $personal->actividad) == 'Operativo' ? 'selected' : ''); ?>>Operativo</option>
                                        <option value="Instructor Canino" <?php echo e(old('actividad', $personal->actividad) == 'Instructor Canino' ? 'selected' : ''); ?>>Instructor Canino</option>
                                        <option value="Terapeuta" <?php echo e(old('actividad', $personal->actividad) == 'Terapeuta' ? 'selected' : ''); ?>>Terapeuta</option>
                                    </select>

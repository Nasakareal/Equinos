...
<?php $__env->startSection('title', 'Crear Armamento'); ?>

<?php $__env->startSection('content_header'); ?>
    <h1>Creación de Armamento</h1>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('armamento.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="CORTA" <?php echo e(old('tipo') === 'CORTA' ? 'selected' : ''); ?>>CORTA</option>
                                        <option value="LARGA" <?php echo e(old('tipo') === 'LARGA' ? 'selected' : ''); ?>>LARGA</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                    <small class="text-muted">Solo se permiten: CORTA o LARGA.</small>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                                    <small class="text-muted">Debe ser única (no repetida).</small>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="INACTIVA" <?php echo e(old('estado') === 'INACTIVA' ? 'selected' : ''); ?>>INACTIVA</option>
...
unset($__errorArgs, $__bag); ?>"
                                           value="<?php echo e(old('marca_modelo')); ?>"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\equinosCaninos\resources\views/armamento/create.blade.php ENDPATH**/ ?>
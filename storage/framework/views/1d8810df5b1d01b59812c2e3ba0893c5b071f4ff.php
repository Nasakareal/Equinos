            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(url('/admin/settings/roles/create')); ?>" class="btn btn-primary">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($rol->created_at->format('d-m-Y')); ?></td>
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(url('/admin/settings/roles/' . $rol->id)); ?>" class="btn btn-info btn-sm">
                                                <i class="fa-regular fa-eye"></i> Ver
                                            </a>
                                            <a href="<?php echo e(url('/admin/settings/roles/' . $rol->id . '/edit')); ?>" class="btn btn-success btn-sm">
                                                <i class="fa-regular fa-pen-to-square"></i> Editar
                                            </a>
                                            <a href="<?php echo e(url('/admin/settings/roles/' . $rol->id . '/permissions')); ?>" class="btn btn-warning btn-sm">
                                                <i class="fa-solid fa-key"></i> Permisos
                                            </a>
                                            
                                            <form action="<?php echo e(url('/admin/settings/roles/' . $rol->id)); ?>" 
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\equinosCaninos\resources\views/admin/settings/roles/index.blade.php ENDPATH**/ ?>